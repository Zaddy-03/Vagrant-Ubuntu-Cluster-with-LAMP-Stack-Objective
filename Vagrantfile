  ...
  Vagrant.configure("2") do |config|
    ...
    config.vm.define "master" do |master|
      ...
      master.vm.provision "shell", inline: <<-SHELL
        ...
        echo "mysql-server mysql-server/root_password password 53669" | sudo debconf-set-selections
        echo "mysql-server mysql-server/root_password_again password 53669" | sudo debconf-set-selections
